...
$endif$
$if(tables)$
\usepackage{longtable,booktabs, adjustbox, etoolbox}
...
$if(majpatternbookversion)$
\newcommand{\majpatternbookversion}{$majpatternbookversion$}
$endif$
...
\vfill
\LARGE
\centering{Version} \majpatternbookversion
\vfill
\centering{\today}
\vfill
\end{titlepage}
